...
import { Draft, PEN, INK, paperTileURL } from './draft.js?v=20260813-0202';
import { SECTIONS, SHEET_W, TABS, CHART, COL, CTL_NOTE_W, balance,
         proseColumns, measureSections, SHEET_CW } from './sections.js?v=20260813-0202';
import { column, fmtNum } from './instruments.js?v=20260813-0202';
import { describe, headline } from './narrative.js?v=20260813-0202';
import { chooseFigures } from './figures.js?v=20260813-0202';
