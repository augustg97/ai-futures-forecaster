...
import { Draft, PEN, INK, paperTileURL } from './draft.js?v=20260918-1130';
import { SECTIONS, SHEET_W, TABS, CHART, COL, CTL_NOTE_W, balance,
         proseColumns, measureSections, SHEET_CW, NOTE_TITLE } from './sections.js?v=20260918-1130';
import { column, fmtNum } from './instruments.js?v=20260918-1130';
import { chronicle, provenanceNote, capsFor, trackNote, capsSummary, ledgerEndOf,
         buildLedger, ledgerDiff, branchCaption } from './ledger.js?v=20260918-1130';
import { mulberry32, capPath as capPathE, capAt as capAtE, tracksJS as tracksE,
         ...
         branchEventsJS } from './engine.js?v=20260918-1130';
import { describeRecord, headlineRecord, RECORD, recordAt, whenOf } from './record.js?v=20260918-1130';
import { LONGFORM } from './narrative.js?v=20260918-1130';
import { chooseFigures } from './figures.js?v=20260918-1130';
